...
/// <summary>
/// Adapts Silk keyboard and mouse input into renderer-agnostic camera controller input.
/// </summary>
public sealed class SilkCameraInputAdapter : IInputSource, IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SilkCameraInputAdapter"/> class.
    /// </summary>
    ...
    /// </summary>
    /// <returns>The sampled camera controller input.</returns>
    ...
    /// <summary>
    /// Releases input event subscriptions.
    /// </summary>
    public void Dispose()
    {
        if (_disposed)
    ...
    private Vector2 ReadMouseDelta()
    {
        ...
        _lastMousePosition = position;
        return delta.LengthSquared() <= 0.0f ? Vector2.Zero : delta;
    }
