	...
	namespace Graphics2D
	{
		namespace DirectXTex
		{
			...
			public:
				...
				/// </summary>
				/// <param name="metaData">Metadata to initialize the image with</param>
				ScratchImage(Int32 width, Int32 height, ScratchImageFormat format);
				...
				/// <param name="filePath">Image file path</param>
				/// <param name="format">The <see cref="ScratchImageFileFormat"/>/Type of the Image</param>
				ScratchImage(array<Byte>^ buffer, ScratchImageFileFormat format);

				/// <summary>
				/// Initializes the <see cref="ScratchImage"/> with the given params
				/// </summary>
				/// <param name="metaData">Metadata to initialize the image with</param>
				void InitializeImage(Int32 width, Int32 height, ScratchImageFormat format);
				...
				/// <summary>
				/// Calculates the row pitch from the provided information.
				/// </summary>
				/// <param name="fmt">The image format.</param>
				/// <param name="width">The image width.</param>
				/// <param name="height">The image height.</param>
				/// <param name="outRowPitch">The resulting row pitch.</param>
				/// <param name="outSlicePitch">The resulting slice pitch.</param>
				/// <returns>True if success, otherwise false.</returns>
				static bool TryCalculatePitch(ScratchImageFormat fmt, Int64 width, Int64 height, [Out] Int64% outRowPitch, [Out] Int64% outSlicePitch)
				{
					size_t rowPitch = 0, slicePitch = 0;
					HRESULT hr = DirectX::ComputePitch((DXGI_FORMAT)fmt, width, height, rowPitch, slicePitch, DirectX::CP_FLAGS_NONE);
