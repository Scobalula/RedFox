...
namespace RedFox.Graphics2D.Tiff
{
    ...
    public sealed class TiffImageTranslator : ImageTranslator
    {
        ...
        /// <summary>
        /// Determines byte order from the first two bytes of the TIFF header.
        /// </summary>
        ...
        /// <summary>
        /// Writes a 16-bit unsigned integer with the specified byte order.
        /// </summary>
        ...
        /// <summary>
        /// Writes a 32-bit unsigned integer with the specified byte order.
        /// </summary>
