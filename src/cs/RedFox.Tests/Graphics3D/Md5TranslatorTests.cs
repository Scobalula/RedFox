...
//        SkeletonBone skeleton = scene.RootNode.AddNode(new SkeletonBone("Skeleton"));
...
//        SkeletonAnimation animation = scene.RootNode.AddNode(new SkeletonAnimation("SelectedAnim", 2, TransformType.Absolute)
//        {
//            Framerate = 24f,
...
//        SkeletonBone skel = scene.RootNode.AddNode<SkeletonBone>("Skeleton");
