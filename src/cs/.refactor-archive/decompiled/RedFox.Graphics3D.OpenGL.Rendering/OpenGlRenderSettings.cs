...
{
	/// <summary>
	/// Gets or sets the framebuffer clear color.
	/// </summary>
	public Vector4 ClearColor { get; set; }

	/// <summary>
	/// Gets or sets the ambient light contribution.
	/// </summary>
	...
	/// <summary>
	/// Gets or sets the scene up-axis used for mesh/light rendering conversion.
	/// </summary>
	public OpenGlUpAxis UpAxis { get; set; } = OpenGlUpAxis.Y;

	/// <summary>
	/// Gets or sets the front-face winding used for culling.
	/// </summary>
	public OpenGlFaceWinding FaceWinding { get; set; } = OpenGlFaceWinding.Ccw;

	/// <summary>
	/// Gets or sets the Phong specular strength.
	/// </summary>
	public float SpecularStrength { get; set; } = 0.28f;

	/// <summary>
	/// Gets or sets the Phong shininess power.
	/// </summary>
	...
	/// <summary>
	/// Gets or sets the skinning algorithm used by GPU skinning.
	/// </summary>
	...
	/// <summary>
	/// Gets or sets a value indicating whether skeleton bones should render on top of scene geometry.
	/// </summary>
	...
	/// <summary>
	/// Gets or sets the parent-length multiplier used to auto-scale bone axis size.
	/// </summary>
	public float BoneAxisScaleFromParent { get; set; } = 0.2f;

	/// <summary>
	/// Gets or sets the maximum axis size used by auto-scaling. Set to 0 to disable clamping.
	/// </summary>
	public float BoneAxisMaxSize { get; set; } = 2f;

	/// <summary>
	/// Gets or sets the pixel width of rendered skeleton bone lines.
	/// </summary>
	...
	/// </summary>
	public Vector4 BoneAxisXColor { get; set; } = new Vector4(0.9f, 0.25f, 0.25f, 0.95f);

	/// <summary>
	/// Gets or sets the color of the rendered Y axis at each bone.
	/// </summary>
	public Vector4 BoneAxisYColor { get; set; } = new Vector4(0.25f, 0.9f, 0.25f, 0.95f);

	/// <summary>
	/// Gets or sets the color of the rendered Z axis at each bone.
	/// </summary>
	public Vector4 BoneAxisZColor { get; set; } = new Vector4(0.25f, 0.45f, 0.95f, 0.95f);

	/// <summary>
	/// Gets or sets the color of the parent-to-child bone connection line.
	/// </summary>
	public Vector4 BoneConnectionColor { get; set; } = new Vector4(0.88f, 0.88f, 0.76f, 0.9f);

	/// <summary>
	/// Gets or sets a value indicating whether each bone connection line should use a deterministic color derived from the bone name.
	/// </summary>
	...
	public OpenGlRenderSettings(Vector4 clearColor, Vector3 ambientColor, Vector3 fallbackLightDirection, Vector3 fallbackLightColor, float fallbackLightIntensity)
	{
