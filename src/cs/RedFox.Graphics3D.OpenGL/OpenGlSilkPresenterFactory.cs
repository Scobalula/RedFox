...
/// <summary>
/// Creates OpenGL renderer presenters for the shared Silk renderer host.
/// </summary>
public sealed class OpenGlSilkPresenterFactory : ISilkGraphicsPresenterFactory
{
    ...
    /// <summary>
    /// Creates an OpenGL renderer presenter for the loaded window.
    /// </summary>
