...
{
    /// <summary>
    /// Codec for <see cref="ImageFormat.R16G16Typeless"/>, <see cref="ImageFormat.R16G16Float"/>,
    /// <see cref="ImageFormat.R16G16Unorm"/>, <see cref="ImageFormat.R16G16Uint"/>,
    /// <see cref="ImageFormat.R16G16Snorm"/>, and <see cref="ImageFormat.R16G16Sint"/>.
    ...
    public sealed class R16G16Codec : IPixelCodec
    {
        ...
        public R16G16Codec(ImageFormat format)
        {
            ...
            {
                ImageFormat.R16G16Typeless => format,
                ImageFormat.R16G16Float => format,
                ImageFormat.R16G16Unorm => format,
                ImageFormat.R16G16Uint => format,
                ImageFormat.R16G16Snorm => format,
                ImageFormat.R16G16Sint => format,
