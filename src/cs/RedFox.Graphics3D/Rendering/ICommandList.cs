...
{
    /// <summary>
    /// Gets the command-list frame index. Incremented each time <see cref="Reset"/> starts a new frame.
    /// </summary>
    ...
    /// <summary>
    /// Resolves or copies the source render target into the destination render target.
    /// </summary>
    /// <param name="source">The source render target.</param>
    /// <param name="destination">The destination render target, or <see langword="null"/> for the default target.</param>
    void ResolveRenderTarget(IGpuRenderTarget source, IGpuRenderTarget? destination);
    ...
    /// <param name="name">The uniform name.</param>
    /// <param name="value">The uniform value.</param>
    void SetUniformVector2(string name, Vector2 value);
    ...
    /// <param name="name">The uniform name.</param>
    /// <param name="value">The uniform value.</param>
    void SetUniformVector3(string name, Vector3 value);
    ...
    /// <param name="name">The uniform name.</param>
    /// <param name="value">The uniform value.</param>
    void SetUniformVector4(string name, Vector4 value);
    ...
    /// <param name="name">The uniform name.</param>
    /// <param name="value">The uniform value.</param>
    void SetUniformMatrix4x4(string name, Matrix4x4 value);
