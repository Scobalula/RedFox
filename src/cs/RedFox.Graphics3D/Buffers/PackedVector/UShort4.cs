...
{
    /// <summary>
    /// Packs a 4-component unsigned 16-bit integer vector into a single <see cref="ulong"/>.
    /// </summary>
    public struct UShort4 : IPackedVector<UShort4>
    {
        ...
        public UShort4(ulong packedValue) => _packed = packedValue;
        ...
        public UShort4(float x, float y, float z, float w) => Pack(new Vector4(x, y, z, w));
        ...
        public void Pack(Vector4 value)
        {
            ...
            var z = (ushort)Math.Clamp(MathF.Round(value.Z), 0, 65535);
            var w = (ushort)Math.Clamp(MathF.Round(value.W), 0, 65535);
