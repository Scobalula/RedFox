...
{
    /// <summary>
    /// Packs a 2-component signed 16-bit integer vector into a single <see cref="uint"/>.
    /// </summary>
    public struct Short2 : IPackedVector<Short2>
    {
        ...
        public Short2(uint packedValue) => _packed = packedValue;
        ...
        public Short2(float x, float y) => Pack(new Vector4(x, y, 0f, 0f));
